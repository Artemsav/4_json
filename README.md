...
Для работы скрипту необходимо указать путь к файлу, который необходимо прочитать и мы получим:
    ...
    $ python pprint_json.py <path to file>
     [{
    	...
    	"Cells": {
    		...
    		"geoData": {
    			"type": "Point",
    			"coordinates": [37.39703804817934, 55.740999719549094]
    		}
    	}
    }, {
    	...
    	"Cells": {
    		...
    		"geoData": {
    			"type": "Point",
    			"coordinates": [37.593177064306758, 55.897722369367969]
    		}
    	}
    }, {
    	...
    	"Cells": {
    		...
    		"geoData": {
    			"type": "Point",
    			"coordinates": [37.588035999647531, 55.89020100016689]
    		}
    	}
    }]
...
Код написан для учебных целей. Курс вебразработчиков на - [DEVMAN.org](https://devman.org)
